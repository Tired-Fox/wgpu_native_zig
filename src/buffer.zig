...
extern fn wgpuBufferWriteMappedRange(buffer: *Buffer, offset: usize, data: *anyopaque, size: usize) Status;
...
pub const Buffer = opaque {
    ...
    pub inline fn readMappedRange(self: *Buffer, offset: usize, data: *anyopaque, size: usize) Status {
        return wgpuBufferReadMappedRange(self, offset, data, size);
    }
    pub inline fn writeMappedRange(self: *Buffer, offset: usize, data: *anyopaque, size: usize) Status {
