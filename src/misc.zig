...
pub const FeatureName = enum(u32) {
    ...
    texture_compression_bc_sliced3_d                              = 0x00000005,
    texture_compression_etc2                                      = 0x00000006,
    texture_compression_astc                                      = 0x00000007,
    texture_compression_astc_sliced3_d                            = 0x00000008,
    ...
    shader_int_64                                                 = 0x00030026,
    shader_float_32_atomic                                        = 0x00030027,
    texture_atomic                                                = 0x00030028,
    texture_format_p010                                           = 0x00030029,
    pipeline_cache                                                = 0x0003002b,
    shader_int_64_atomic_min_max                                  = 0x0003002c,
    shader_int_64_atomic_all_ops                                  = 0x0003002d,
    texture_int_64_atomic                                         = 0x00030030,
